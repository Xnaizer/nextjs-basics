      ...
      <div className="w-full max-w-[100rem] mx-auto flex flex-col md:flex-col lg:flex-row justify-between items-start gap-12  lg:p-16">
        ...
        <div className="w-full lg:w-1/2 grid grid-cols-1 sm:grid-cols-2 gap-6 text-white text-center p-10">
          <div className="bg-white/30 backdrop-blur-sm p-6 rounded-2xl shadow-lg hover:shadow-cyan-500/30 transition-shadow duration-300 h-full py-10 sm:py-12">
            ...
            <p className="mt-2 text-lg sm:text-xl md:text-3xl text-cyan-300 font-light">Total Managed Funds</p>
          </div>
          ...
          <div className="bg-white/30 backdrop-blur-sm p-6 rounded-2xl shadow-lg hover:shadow-cyan-500/30 transition-shadow duration-300 h-full py-10 sm:py-12">
            ...
            <p className="mt-2 text-lg sm:text-xl md:text-3xl text-cyan-300 font-light">Total Managed Projects</p>
          </div>
        </div>
      </div>
